...
function registerBlock() {
    ...
    wpcf7_add_form_tag(
        array('treatmentreferral', 'treatmentreferral*'),
        'treatmentReferralFormTagHandler',
        array('name-attr' => true)
    );
}


function treatmentReferralFormTagHandler($tag) {
    if(empty($tag->name)) {
        return '';
    }
    $html = '<div class="inner position-relative referral-input"><input type="text" data-referral name="'. esc_attr($tag->name) .'" class="cf7custom-input-field w-full text-xl" placeholder="Referral Code"><div class="response-handler" style="display: none;"></div>
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="success-icon" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
    </div>';
    return $html;
}
